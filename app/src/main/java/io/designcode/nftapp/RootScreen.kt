...
import io.designcode.nftapp.NavigationItem.Login.route
    ...
    BottomNavigation(
        ...
        items.forEach { item ->
            BottomNavigationItem(
                icon = { Image(imageVector = item.icon, contentDescription = item.title, modifier = Modifier.size(30.dp), colorFilter = ColorFilter.tint(Color.White)) },
